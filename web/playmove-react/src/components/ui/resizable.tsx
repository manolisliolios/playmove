...
function ResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className={cn("z-10 flex h-4 w-3 shrink-0 items-center justify-center rounded-xs border", darkMode ? "bg-gray-800" : "bg-gray-200")}
        >
          <GripVerticalIcon className={cn("size-2.5", darkMode ? "text-white" : "text-black")}
          />
        </div>
      )}
    </ResizablePrimitive.PanelResizeHandle>
